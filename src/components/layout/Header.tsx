      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4 flex-grow">
          <div className="hidden md:block">
            {/* 🟢 CHANGED: Replaced dynamic section name with fixed Hospital Name */}
            <span className="ml-4 text-lg font-medium text-white capitalize">
              Life Line Health Care Hospital Coimbatore
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3 border-l border-white/20 pl-4">
            ...
            <div className="flex flex-col items-end">
              ...
              <p className="text-xs text-white/70">{formatRole(userRole)}</p>
            </div>
          </div>
        </div>
      </div>
